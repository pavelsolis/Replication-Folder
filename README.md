...
Once you have created your project repository from the template, delete up to this line to only leave the description of your specific project in the main page of the repository.
