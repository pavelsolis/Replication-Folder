%% Packages for Beamer
% Lists, Fromatting, Math, Figures, Tables,
% Special Characters, Hyperlinks, References

%---------------------------------------------------------------
% Lists
%---------------------------------------------------------------
\usepackage{enumerate} 							% Customizes the enumerate style
\setbeamertemplate{enumerate items}[default]
\setbeamertemplate{itemize items}{$\bullet$}	% {$\vdash$}
...
% References
%---------------------------------------------------------------
%\usepackage[style=authoryear,backend=biber,maxbibnames=99,maxcitenames=5,dashed=false]{biblatex} % To read bib data
%\addbibresource{../References/library.bib}		% Imports bib file
